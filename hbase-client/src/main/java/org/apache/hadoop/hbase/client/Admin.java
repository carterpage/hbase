...
public interface Admin extends Abortable, Closeable {
  ...
  @Override void abort(String why, Throwable e);

  @Override boolean isAborted();
  ...
  boolean tableExists(final byte[] tableName) throws IOException;

  boolean tableExists(final String tableName) throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  @Deprecated String[] getTableNames() throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  @Deprecated String[] getTableNames(Pattern pattern) throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  @Deprecated String[] getTableNames(String regex) throws IOException;
  ...
  HTableDescriptor getTableDescriptor(final byte[] tableName)
      throws TableNotFoundException, IOException;
  ...
  void deleteTable(final String tableName) throws IOException;
  ...
  void enableTable(final String tableName) throws IOException;
  ...
  void enableTableAsync(final byte[] tableName) throws IOException;

  void enableTableAsync(final String tableName) throws IOException;
  ...
  void disableTableAsync(final byte[] tableName) throws IOException;

  void disableTableAsync(final String tableName) throws IOException;
   ...
   *
   * @param tableName
   * @throws IOException There could be couple types of IOException
   *                     TableNotFoundException means the table doesn't exist.
  ...
  void disableTable(final String tableName) throws IOException;
  ...
  boolean isTableAvailable(String tableName, byte[][] splitKeys) throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  void addColumn(final String tableName, HColumnDescriptor column) throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  void deleteColumn(final byte[] tableName, final String columnName) throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  void deleteColumn(final String tableName, final String columnName) throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  void modifyColumn(final String tableName, HColumnDescriptor descriptor) throws IOException;
   ...
   * @throws IOException if a remote or network exception occurs
   */
  void modifyColumn(final byte[] tableName, HColumnDescriptor descriptor) throws IOException;
   ...
   *
   * @param encodedRegionName The encoded region name; i.e. the hash that makes up the region
   *                          name suffix: e.g. if regionname is
   *                          <code>TestTable,0094429456,1289497600452.527db22f95c8a9e0116f0cc13c680396.</code>
   *                          , then the encoded region name is:
   *                          <code>527db22f95c8a9e0116f0cc13c680396</code>.
   * @param serverName        The servername of the regionserver. A server name is made of host,
  ...
  void modifyTable(final byte[] tableName, final HTableDescriptor htd) throws IOException;

  void modifyTable(final String tableName, final HTableDescriptor htd) throws IOException;
  ...
  List<HRegionInfo> getTableRegions(final byte[] tableName) throws IOException;
   ...
   * a {@link org.apache.hadoop.hbase.snapshot.SnapshotCreationException} indicating the duplicate naming.
   ...
   * @throws org.apache.hadoop.hbase.snapshot.UnknownSnapshotException if the requested snapshot is unknown
   */
   ...
   * @throws IOException                                               if a remote or network exception occurs
   * @throws org.apache.hadoop.hbase.snapshot.RestoreSnapshotException if snapshot failed to be restored
   ...
   * @throws IOException                                  if a remote or network exception occurs
   * @throws org.apache.hadoop.hbase.TableExistsException if table to be created already exists
   * @throws RestoreSnapshotException                     if snapshot failed to be cloned
   * @throws IllegalArgumentException                     if the specified table has not a valid name
   */
  void cloneSnapshot(final byte[] snapshotName, final byte[] tableName)
